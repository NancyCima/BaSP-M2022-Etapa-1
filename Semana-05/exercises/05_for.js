...
var dessertArray = ['lemon pie', 'cheesecake', 'chocotorta', 'ice cream', 'puddin'];
for (var i = 0; i < dessertArray.length; i++) {
    alert(dessertArray[i]);
}
...
for (var i = 0; i < dessertArray.length; i++) {
    alert(dessertArray[i].substring(0,1).toUpperCase() + dessertArray[i].substring(1));
}
...
var sentence = '';
for (var i = 0; i < dessertArray.length; i++) {
    sentence = sentence + '  ' + dessertArray[i];
}
alert(sentence);
